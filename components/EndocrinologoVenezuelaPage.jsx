      ...
      <section className="py-8 bg-white border-y border-malva-100">
        <div className="container-page max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {ciudades.map((c) => (
              <span key={c} className="px-3 py-1.5 rounded-full bg-malva-50 border border-malva-100 text-sm text-malva-800">
                {c}
              </span>
            ))}
          </div>
        ...
        <div className="container-page max-w-4xl mx-auto">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {conditions.map((c) => (
              ...
              >
                <h3 className="font-[family-name:var(--font-display)] text-base font-semibold text-malva-900 group-hover:text-dorado-dark transition-colors">{c.title}</h3>
