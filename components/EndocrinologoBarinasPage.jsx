...
const faqs = [
  {
    q: "Dónde esta el endocrinólogo en Barinas?",
    a: "La Dra. Jennifer Manrique atiende en el Hospital Privado San Juan, Consultorio 34, Piso 2, Barinas. Es la endocrinóloga de referencia en la ciudad, egresada de la ULA con formación internacional en el CEMDI Bogota.",
  },
  {
    q: "Cómo saco cita con el endocrinólogo en Barinas?",
    a: "La forma más rápida es por WhatsApp al 0412-9337390. La atención es de lunes a viernes de 8:00 AM a 12:00 PM y de 2:00 PM a 6:00 PM, previa cita. También se puede coordinar para la sede de Santa Barbara de Barinas.",
  },
  {
    q: "Qué diferencia hay entre endocrino y endocrinologo?",
    a: "Son el mismo especialista. Endocrinólogo es el termino formal correcto para el médico especialista en el sistema endocrino y hormonal. Endocrino es la forma coloquial común en Venezuela y Latinoamerica.",
  },
  {
    q: "Cuánto cuesta la consulta del endocrinólogo en Barinas?",
    a: "El valor de la consulta se confirma directamente por WhatsApp al 0412-9337390, ya qué puede variar según el tipo de consulta (primera vez o seguimiento) y la evolucion del caso.",
  },
  {
    q: "El endocrinólogo en Barinas atiende niños?",
    a: "Si. La Dra. Jennifer Manrique realiza evaluación endocrinológica pediatrica: talla baja, pubertad precoz o retrasada y deficiencia de hormona de crecimiento en niños y adolescentes.",
  },
  {
    q: "Qué estudios debo llevar a la primera consulta con el endocrinologo?",
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_320px] items-start">
            <div>
              ...
              <p className="mt-4 text-base leading-relaxed text-texto-suave">
                ...
                médicas más prestigiosas de Venezuela. Completo su formación con una
              ...
              <p className="mt-3 text-base leading-relaxed text-texto-suave">
                ...
                manejo de tecnología avanzada cómo monitores continuos de glucosa
        ...
        <div className="container-page max-w-4xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="mt-3 text-base text-texto-suave">
              Atención integral para todas las condiciónes del sistema endocrino
