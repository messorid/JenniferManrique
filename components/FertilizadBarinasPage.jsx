...
const features = [
  {
    title: "Evaluación Hormonal para Infertilidad",
    desc: "Panel hormonal completo (FSH, LH, estradiol, progesterona, prolactina, TSH, testosterona) para identificar causas endocrinas de la dificultad para concebir.",
  },
  {
    title: "SOP y Fertilidad",
    desc: "El síndrome de ovario poliquístico es la causa hormonal más frecuente de infertilidad femenina. Protocolo específico para inducir ovulación y lograr el embarazo.",
  },
  {
    title: "Hipotiroidismo y Embarazo",
    desc: "Control y ajuste de la función tiroidea antes y durante la gestación. La TSH debe estar óptima para favorecer la concepción y proteger el desarrollo del bebé.",
  },
  {
    title: "Hiperprolactinemia",
    desc: "El exceso de prolactina inhibe la ovulación. Diagnóstico y tratamiento médico para restaurar la función reproductiva sin necesidad de cirugía en la mayoría de casos.",
  },
  {
    title: "Hipogonadismo Masculino",
    desc: "Evaluación hormonal del hombre con baja testosterona o alteraciones en el esperma de causa endocrina. Tratamiento para recuperar la función reproductiva.",
  },
  {
    title: "Protocolo Pre-concepcional",
    desc: "Optimización hormonal completa antes del embarazo: tiroides, insulina, prolactina y peso corporal para maximizar las probabilidades de éxito.",
  },
];

const faqs = [
  {
    q: "¿Cuándo debo ver a un endocrinólogo por infertilidad?",
    a: "Si llevas más de 6 meses intentando concebir sin éxito (o 12 meses si tienes menos de 35 años), o si tienes condiciones como SOP, hipotiroidismo, ciclos irregulares o alteraciones hormonales conocidas, es recomendable consultar con la Dra. Manrique.",
  },
  {
    q: "¿Qué causas hormonales pueden impedir el embarazo?",
    a: "Las más frecuentes son el síndrome de ovario poliquístico (SOP), el hipotiroidismo, la hiperprolactinemia (prolactina elevada), la insuficiencia ovárica prematura y la resistencia a la insulina. La Dra. Manrique evalúa todas estas causas en una consulta inicial.",
  },
  {
    q: "¿El endocrinólogo reemplaza al ginecólogo en problemas de fertilidad?",
    a: "No, son complementarios. El endocrinólogo maneja las causas hormonales y metabólicas, mientras el ginecólogo o el especialista en reproducción asistida maneja el aspecto anatómico y los procedimientos. La Dra. Manrique trabaja en coordinación con los demás especialistas.",
  },
  {
    q: "¿El hipotiroidismo causa infertilidad?",
    a: "Sí. El hipotiroidismo no controlado altera la ovulación y aumenta el riesgo de aborto espontáneo. Con tratamiento adecuado y TSH en rango óptimo, muchas mujeres logran concebir sin dificultad. La Dra. Manrique ajusta la levotiroxina específicamente para el embarazo.",
  },
  {
    q: "¿Qué es la evaluación hormonal de fertilidad?",
    a: "Es un panel de exámenes de sangre que incluye FSH, LH, estradiol, progesterona, prolactina, TSH, testosterona, AMH (hormona antimülleriana) y otros según el caso. Se evalúa en momentos específicos del ciclo menstrual para obtener resultados precisos.",
  },
  {
    q: "¿La Dra. Manrique atiende casos de fertilidad en Barinas?",
    a: "Sí. La Dra. Manrique ofrece evaluación hormonal completa y manejo endocrinológico de la infertilidad en el Hospital Privado San Juan, Barinas. Para procedimientos de reproducción asistida (como FIV) coordina con especialistas en reproducción.",
  },
];

export default function FertilizadBarinasPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="container-page relative max-w-3xl mx-auto text-center">
          <nav aria-label="Ruta de navegación" className="mb-6">
            <ol className="flex justify-center flex-wrap gap-x-2 text-xs text-texto-suave">
              ...
              <li className="text-malva-900 font-medium" aria-current="page">Fertilidad en Barinas</li>
            </ol>
          </nav>
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-malva-100 text-malva-800 text-xs font-semibold uppercase tracking-[0.2em]">
            ...
            Fertilidad y Salud Reproductiva · Barinas
          </span>
          <h1 className="mt-6 font-[family-name:var(--font-display)] text-4xl md:text-5xl lg:text-6xl leading-[1.08] text-malva-900">
            Evaluación Hormonal de{" "}
            <span className="text-dorado">Fertilidad</span>{" "}
            en Barinas
          </h1>
          <p className="mt-5 text-base md:text-lg leading-relaxed text-texto-suave max-w-2xl mx-auto">
            La Dra. Jennifer Manrique ofrece evaluación y manejo endocrinológico
            de la infertilidad en Barinas. Diagnóstico hormonal completo para SOP,
            hipotiroidismo, hiperprolactinemia y optimización pre-concepcional.
          </p>
        ...
        <div className="container-page max-w-4xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="mt-3 font-[family-name:var(--font-display)] text-2xl md:text-3xl text-malva-900">
              Causas hormonales de infertilidad que tratamos en Barinas
            </h2>
            <p className="mt-3 text-base text-texto-suave">
              Evaluación endocrinológica completa para identificar y tratar las causas hormonales de la dificultad para concebir.
            </p>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_300px] items-start">
            <div>
              ...
              <h2 className="mt-3 font-[family-name:var(--font-display)] text-2xl md:text-3xl text-malva-900 leading-tight">
                Endocrinóloga especialista en fertilidad hormonal en Barinas
              </h2>
              <p className="mt-4 text-base leading-relaxed text-texto-suave">
                ...
                de la Universidad de Los Andes (ULA). La evaluación hormonal de
                la fertilidad forma parte integral de su práctica, atendiendo
                pacientes con SOP, hipotiroidismo, hiperprolactinemia y otras causas
                endocrinas de dificultad para concebir.
              </p>
              <p className="mt-3 text-base leading-relaxed text-texto-suave">
                Su enfoque busca identificar y corregir todas las alteraciones
                hormonales que puedan estar limitando la fertilidad, optimizando
                el ambiente hormonal antes y durante el embarazo. Trabaja en
                coordinación con ginecólogos y especialistas en reproducción
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container-page max-w-3xl mx-auto">
          <h2 className="font-[family-name:var(--font-display)] text-2xl md:text-3xl text-malva-900 text-center mb-10">
            Preguntas sobre fertilidad hormonal en Barinas
          </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-malva-700 via-malva-800 to-malva-900 relative overflow-hidden">
        ...
        <div className="relative container-page text-center max-w-2xl mx-auto text-white">
          <h2 className="font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight">
            Agenda tu evaluación de fertilidad en Barinas
          </h2>
