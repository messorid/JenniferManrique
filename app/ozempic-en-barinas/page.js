...
export const metadata = {
  ...
  keywords: [
    ...
    "Ozempic endocrinologo Barinas",
    "Ozempic para bajar de peso Venezuela",
    "Ozempic diabetes Barinas",
    "donde conseguir Ozempic Venezuela",
  ...
  openGraph: {
    ...
    title: "Ozempic en Barinas | Semaglutida Venezuela - Dra. Jennifer Manrique",
    description:
      "Ozempic disponible en Barinas. Prescripcion y seguimiento con la Dra. Jennifer Manrique, endocrinologa especialista en Venezuela.",
  ...
  twitter: {
    ...
    description: "Ozempic (semaglutida) en Barinas. Prescripcion y seguimiento con endocrinologa especialista.",
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Si, Ozempic (semaglutida) esta disponible en Venezuela bajo prescripcion medica. La Dra. Jennifer Manrique lo prescribe y hace seguimiento en Barinas." },
    },
    {
      "@type": "Question",
      name: "Para que sirve Ozempic?",
      acceptedAnswer: { "@type": "Answer", text: "Ozempic esta aprobado para diabetes tipo 2 y se usa bajo supervision medica para manejo del peso. Reduce el apetito, mejora el control glucemico y favorece la perdida de peso sostenida." },
    },
    {
      "@type": "Question",
      name: "Cual es la diferencia entre Ozempic y Mounjaro?",
      acceptedAnswer: { "@type": "Answer", text: "Ozempic actua sobre el receptor GLP-1. Mounjaro actua sobre GLP-1 y GIP (doble accion), mostrando mayor eficacia en perdida de peso. La eleccion depende del perfil de cada paciente." },
    },
    {
      "@type": "Question",
      name: "Como agendo cita para Ozempic en Barinas?",
